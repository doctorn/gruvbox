...
let s:iro.light0_soft = ['#ffffff', 231]
"TODO replace
...
let s:iro.bright_blue     = ['#cf58bd', 169]
let s:iro.bright_purple   = ['#31a9f3', 75]
let s:iro.bright_aqua     = ['#f95882', 204]
...
let s:iro.neutral_purple = ['#cb48b7', 169]
let s:iro.neutral_aqua   = ['#f94a76', 204]
...
let s:iro.faded_blue     = ['#cf58bd', 169]
let s:iro.faded_purple   = ['#31a9f3', 75]
let s:iro.faded_aqua     = ['#f95882', 204]
